...
class RolloutPolicy(object):
    ...
    def __init__(
        self, policy, obs_normalization_stats=None, acs_normalization_stats=None
    ):
        """
        Args:
        ...
        self.acs_normalization_stats = acs_normalization_stats
    ...
    def _postprocess_action(self, ac):
        mean = self.acs_normalization_stats["mean"]
        std = self.acs_normalization_stats["std"]
        return ac * std + mean
    ...
    def __call__(self, ob, goal=None):
        ...
        if self.acs_normalization_stats is not None:
