...
class WandbLogger(object):
    ...
    def __init__(self, config):
        ...
        wandb.init(project="awe", entity="lucys", config=config, name=run_name)
        ...
        if data_type == "scalar":
            ...
            if log_stats:
                ...
                for stat_k, stat_v in stats.items():
                    ...
                    wandb.log({stat_k_name: stat_v}, step=epoch)
        elif data_type == "image":
            wandb.log({k: [wandb.Image(v)]}, step=epoch)
        elif data_type == "video":
            wandb.log({k: [wandb.Video(v)]}, step=epoch)
