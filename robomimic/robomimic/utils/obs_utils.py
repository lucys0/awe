...
def normalize_obs(obs_dict, obs_normalization_stats):
    ...
    # if not set(obs_dict.keys()).issubset(obs_normalization_stats):
...
def normalize_acs(acs, acs_normalization_stats):
    mean = acs_normalization_stats["mean"]
    std = acs_normalization_stats["std"]
    return (acs - mean) / std
